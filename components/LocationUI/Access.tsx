                ...
                >
                    ...
                    <div className="space-y-8 text-gray-700 leading-relaxed font-jp">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-block border border-black/30 px-6 py-3 text-sm hover:bg-[#092040] hover:text-white hover:border-[#092040] transition-colors duration-300 rounded-full"
                        >
                            Google Mapで見る
                        </a>
                    </div>
