...
export default function ThemeMessage() {
    // 【調整箇所①】画像とコンテンツの間の距離
    const spacingTop = "mt-50 md:mt-65";
    ...
    return (
        <section className="relative w-full bg-black py-24 md:py-40 overflow-hidden flex flex-col items-center">
            ...
            {/* コンテンツエリア */}
            <div className={`relative z-10 w-full max-w-7xl px-6 md:px-12 flex flex-col items-center ${spacingTop}`}>
                    ...
                    {sections.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-center">
                                <span className="font-oswald text-[80px] md:text-[140px] lg:text-[160px] font-black text-white/20 leading-[0.8] tracking-tighter inline-block">
                                    {item.num}
                                </span>
                            </div>
                            ...
                            <div className="flex flex-col justify-center py-2">
                                ...
                                <p className="text-sm md:text-xl text-white/85 font-medium leading-relaxed tracking-wide">
                                    {item.desc}
                                </p>
                            </div>
                        </motion.div>
