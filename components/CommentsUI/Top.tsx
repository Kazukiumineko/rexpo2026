        ...
        <section className="w-full bg-white text-black py-24 md:py-32 px-6 md:px-20 lg:px-32 overflow-hidden">
            ...
            >
                ...
                <motion.h1
                    ...
                    className="font-oswald text-7xl md:text-9xl lg:text-[10rem] font-bold tracking-tight mb-24 lg:mb-40 text-center"
                >
                    MESSAGE
                </motion.h1>
