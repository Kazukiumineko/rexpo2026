        ...
        >
            {isHomePage ? (
                <Image
                    ...
                    className={`object-contain cursor-pointer h-auto w-[100px] md:w-[110px] lg:w-[150px] drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)] ${invert ? "lg:[filter:brightness(0)_saturate(100%)_invert(10%)_sepia(35%)_saturate(3086%)_hue-rotate(193deg)_brightness(95%)_contrast(100%)_drop-shadow(0_1px_2px_rgba(0,0,0,0.5))]" : ""}`}
    ...
    return (
        <>
            <button
                ...
                className={`absolute -top-2 md:top-0 right-4 z-50 w-16 h-16 flex flex-col justify-center items-center gap-2 transition-opacity duration-500 ease-in-out cursor-pointer drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)]
                ${isVisible ? "opacity-100" : "opacity-0 pointer-events-none"}`}
            >
                <span
